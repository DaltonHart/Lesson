...
Go ahead and clone [React Counters](https://git.generalassemb.ly/sf-wdi-45/react-counters.git) now. This will be the code we start with.

```bash
$ git clone https://git.generalassemb.ly/sf-wdi-45/react-counters.git
$ cd react-counters
$ npm install
$ npm run start
```
